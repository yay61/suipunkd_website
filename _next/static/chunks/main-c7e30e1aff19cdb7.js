                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 9:
                      ...
                      break;
                    case 17:
                      return (e.next = 19), te.routeLoader.whenEntrypoint(B);
                    case 19:
                      e.t0 = e.sent;
                    case 20:
                      if (!("error" in (s = e.t0))) {
                          ...
                          for (;;)
                            switch ((o.prev = o.next)) {
                              ...
                              case 64:
                                ...
                                (E = s({}, E, B.parsedAs.query)),
                                  (F = B.asPath),
                                  (x = B.resolvedHref),
                                  (w.pathname = B.resolvedHref),
                                  (r = m.formatWithValidation(w)),
                                  (o.next = 81);
                                break;
                              case 69:
                                ...
                                return o.abrupt(
                                  "return",
                                  this.change(t, B.newUrl, B.newAs, a)
                                );
                              case 73:
                              ...
                              case 102:
                                ...
                                return (
                                  ((oe = _.parseRelativeUrl(ne)).pathname = q(
                                    oe.pathname,
                                    O
                                  )),
                                  (ae = D(this, ne, ne)),
